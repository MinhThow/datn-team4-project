...
('Nguyễn Minh Thơ', 'minhtho.002022@gmail.com', '$2a$10$wdiNfp58as8CFI9.kWD9IuPDYLpe836HZ0rVs8/2FIAFcK1ZyCpWO', '0703285661', 'Cao đẳng FPT', 'admin'),
('Nguyễn Thị Mai', 'mai@gmail.com', '123456', '0901234567', '123 Đường Nguyễn Huệ, Q1, TP.HCM', 'customer'),
('Lê Thị Hoa', 'hoa@gmail.com', '123456', '0923456789', '789 Đường Hai Bà Trưng, Q3, TP.HCM', 'customer'),
('Phạm Minh Tuấn', 'tuan@gmail.com', '123456', '0934567890', '321 Đường Pasteur, Q3, TP.HCM', 'customer'),
...
(1, 2, 5, 'Áo sơ mi chất lượng tốt, vải mềm mại, form chuẩn. Rất hài lòng!'),
(2, 3, 4, 'Áo thun đẹp, form oversize vừa ý, màu sắc như hình. Sẽ mua thêm!'),
(5, 4, 5, 'Túi xách da thật, thiết kế sang trọng, đóng gói cẩn thận. Tuyệt vời!'),
(6, 5, 4, 'Áo khoác bomber đẹp, chất liệu tốt nhưng hơi nhỏ so với size chart.'),
(10, 2, 5, 'Áo len ấm, mềm mại, màu sắc đẹp. Phù hợp mùa đông Sài Gòn.'),
(3, 3, 3, 'Quần jean ổn, nhưng màu hơi khác so với hình. Chất lượng tạm được.'),
(7, 4, 5, 'Đầm maxi xinh xắn, họa tiết hoa nhí dễ thương, vải mát mẻ.'),
(9, 5, 4, 'Giày sneaker thoải mái, đi êm chân, màu trắng dễ phối đồ.'); 