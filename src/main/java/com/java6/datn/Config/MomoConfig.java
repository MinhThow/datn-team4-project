...
public class MomoConfig {
    ...
    public static final String REDIRECT_URL = "http://localhost:8080/api/pay/momo-return";
    public static final String IPN_URL = "http://localhost:8080/api/pay/momo-ipn";
}
